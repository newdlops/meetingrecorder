...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--whisper-cpp-dtw-preset", help="whisper.cpp DTW 토큰 타임스탬프 preset")
    ...
    parser.add_argument("--vad-onset", type=float, default=0.3, help="VAD 발화 시작 민감도")
    parser.add_argument("--vad-offset", type=float, default=0.2, help="VAD 발화 종료 민감도")
